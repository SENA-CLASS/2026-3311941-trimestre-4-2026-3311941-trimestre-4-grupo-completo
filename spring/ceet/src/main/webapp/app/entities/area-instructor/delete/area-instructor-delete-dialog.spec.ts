...
describe('AreaInstructor Management Delete Component', () => {
  let comp: AreaInstructorDeleteDialog;
  let fixture: ComponentFixture<AreaInstructorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AreaInstructorDeleteDialog);
