...
describe('ItemList Management Delete Component', () => {
  let comp: ItemListDeleteDialog;
  let fixture: ComponentFixture<ItemListDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ItemListDeleteDialog);
