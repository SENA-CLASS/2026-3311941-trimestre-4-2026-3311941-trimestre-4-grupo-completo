...
describe('Year Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '7d487a17-3974-4015-af9f-a5353d384918' }], {
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '7d487a17-3974-4015-af9f-a5353d384918' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '7d487a17-3974-4015-af9f-a5353d384918' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to yearService', () => {
      ...
      vitest.spyOn(service, 'getYearIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.yearsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
