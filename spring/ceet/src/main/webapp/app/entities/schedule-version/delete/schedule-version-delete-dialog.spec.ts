...
describe('ScheduleVersion Management Delete Component', () => {
  let comp: ScheduleVersionDeleteDialog;
  let fixture: ComponentFixture<ScheduleVersionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScheduleVersionDeleteDialog);
