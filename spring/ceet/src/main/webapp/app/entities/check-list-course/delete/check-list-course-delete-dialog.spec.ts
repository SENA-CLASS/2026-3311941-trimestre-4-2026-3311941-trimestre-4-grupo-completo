...
describe('CheckListCourse Management Delete Component', () => {
  let comp: CheckListCourseDeleteDialog;
  let fixture: ComponentFixture<CheckListCourseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CheckListCourseDeleteDialog);
