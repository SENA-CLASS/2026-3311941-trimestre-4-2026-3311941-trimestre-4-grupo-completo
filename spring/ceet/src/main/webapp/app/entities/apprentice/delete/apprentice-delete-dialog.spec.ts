...
describe('Apprentice Management Delete Component', () => {
  let comp: ApprenticeDeleteDialog;
  let fixture: ComponentFixture<ApprenticeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ApprenticeDeleteDialog);
