...
describe('GeneralObservation Management Delete Component', () => {
  let comp: GeneralObservationDeleteDialog;
  let fixture: ComponentFixture<GeneralObservationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GeneralObservationDeleteDialog);
