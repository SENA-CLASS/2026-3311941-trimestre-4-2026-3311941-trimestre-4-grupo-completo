...
import { sampleWithNewData, sampleWithRequiredData } from '../area.test-samples';
  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            urlLogo: expect.any(Object),
            areaState: expect.any(Object),
          }),
        );
      });
    ...
    describe('getArea', () => {
      it('should return NewArea for default Area initial value', () => {
        ...
        const area = service.getArea(formGroup);
