...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../area.test-samples';
...
describe('Area Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Area', () => {
      ...
      service.create(area).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Area', () => {
      ...
      service.update(area).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAreaToCollectionIfMissing', () => {
      it('should add a Area to an empty array', () => {
        ...
        expect(expectedResult).toEqual([area]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([area, area2]);
      });
    ...
    describe('compareArea', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '913d13dc-00df-4c1e-98a7-a89896aa2814' };
        const entity2 = null;
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '913d13dc-00df-4c1e-98a7-a89896aa2814' };
        const entity2 = { id: '913d13dc-00df-4c1e-98a7-a89896aa2814' };
