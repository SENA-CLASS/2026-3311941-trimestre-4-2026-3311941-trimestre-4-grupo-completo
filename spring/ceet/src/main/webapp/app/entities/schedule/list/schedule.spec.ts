...
describe('Schedule Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '5c834510-7171-4d53-a4b0-b1d5e8245594' }], {
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '5c834510-7171-4d53-a4b0-b1d5e8245594' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '5c834510-7171-4d53-a4b0-b1d5e8245594' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to scheduleService', () => {
      ...
      vitest.spyOn(service, 'getScheduleIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.schedulesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
