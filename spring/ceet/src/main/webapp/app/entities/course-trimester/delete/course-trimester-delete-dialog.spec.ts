...
describe('CourseTrimester Management Delete Component', () => {
  let comp: CourseTrimesterDeleteDialog;
  let fixture: ComponentFixture<CourseTrimesterDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CourseTrimesterDeleteDialog);
