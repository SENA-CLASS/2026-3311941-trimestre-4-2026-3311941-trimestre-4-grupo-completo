...
describe('GroupResponse Management Delete Component', () => {
  let comp: GroupResponseDeleteDialog;
  let fixture: ComponentFixture<GroupResponseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GroupResponseDeleteDialog);
