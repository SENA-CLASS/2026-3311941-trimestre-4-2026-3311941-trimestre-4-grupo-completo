...
describe('ViewedResult Management Delete Component', () => {
  let comp: ViewedResultDeleteDialog;
  let fixture: ComponentFixture<ViewedResultDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ViewedResultDeleteDialog);
