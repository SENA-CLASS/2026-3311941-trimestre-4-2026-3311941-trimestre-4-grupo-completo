...
import { sampleWithRequiredData } from '../day.test-samples';
...
describe('Day Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '712b4dd0-c635-4121-a9e3-1854687dde35' }], {
    ...
    expect(comp.days()[0]).toEqual(expect.objectContaining({ id: '712b4dd0-c635-4121-a9e3-1854687dde35' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '712b4dd0-c635-4121-a9e3-1854687dde35' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '712b4dd0-c635-4121-a9e3-1854687dde35' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to dayService', () => {
      ...
      vitest.spyOn(service, 'getDayIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDayIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.daysParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
