...
describe('ProjectGroup Management Delete Component', () => {
  let comp: ProjectGroupDeleteDialog;
  let fixture: ComponentFixture<ProjectGroupDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProjectGroupDeleteDialog);
