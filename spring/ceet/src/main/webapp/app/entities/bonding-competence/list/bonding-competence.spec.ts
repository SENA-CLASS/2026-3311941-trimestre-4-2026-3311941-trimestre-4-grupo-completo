...
import { sampleWithRequiredData } from '../bonding-competence.test-samples';
...
describe('BondingCompetence Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: BondingCompetence;
  let fixture: ComponentFixture<BondingCompetence>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BondingCompetence);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '5edac464-b367-4167-9068-576bd03056c9' }], {
    ...
    expect(comp.bondingCompetences()[0]).toEqual(expect.objectContaining({ id: '5edac464-b367-4167-9068-576bd03056c9' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '5edac464-b367-4167-9068-576bd03056c9' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.bondingCompetences()).toEqual([]);

    // WHEN - second load should still work
    comp.load();
    TestBed.tick();
    const successReq = httpMock.expectOne({ method: 'GET' });
    successReq.flush([{ id: '5edac464-b367-4167-9068-576bd03056c9' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to bondingCompetenceService', () => {
      const entity = { id: '5edac464-b367-4167-9068-576bd03056c9' };
      vitest.spyOn(service, 'getBondingCompetenceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBondingCompetenceIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.bondingCompetencesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
