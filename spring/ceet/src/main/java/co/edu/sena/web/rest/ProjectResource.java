...
/**
 * REST controller for managing {@link co.edu.sena.domain.Project}.
 */
@RestController
...
public class ProjectResource {
    ...
    public ResponseEntity<ProjectDTO> createProject(@Valid @RequestBody ProjectDTO projectDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/projects/" + projectDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, projectDTO.getId()))
            .body(projectDTO);
    }
