...
public class PlanningResource {
    ...
    public ResponseEntity<PlanningDTO> createPlanning(@Valid @RequestBody PlanningDTO planningDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/plannings/" + planningDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, planningDTO.getId()))
            .body(planningDTO);
    }
    ...
    public ResponseEntity<PlanningDTO> updatePlanning(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, planningDTO.getId()))
            .body(planningDTO);
    }
    ...
    public ResponseEntity<PlanningDTO> partialUpdatePlanning(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, planningDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<PlanningDTO> getPlanning(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletePlanning(@PathVariable("id") String id) {
