...
public class ScheduleResource {
    ...
    public ResponseEntity<ScheduleDTO> createSchedule(@Valid @RequestBody ScheduleDTO scheduleDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/schedules/" + scheduleDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, scheduleDTO.getId()))
            .body(scheduleDTO);
    }
    ...
    public ResponseEntity<ScheduleDTO> updateSchedule(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, scheduleDTO.getId()))
            .body(scheduleDTO);
    }
    ...
    public ResponseEntity<ScheduleDTO> partialUpdateSchedule(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, scheduleDTO.getId())
        );
    }
