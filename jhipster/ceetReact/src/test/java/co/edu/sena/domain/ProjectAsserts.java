...
public class ProjectAsserts {
    ...
    public static void assertProjectUpdatableFieldsEquals(Project expected, Project actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getProjectCode()).as("check projectCode").isEqualTo(expected.getProjectCode()))
            .satisfies(a -> assertThat(a.getProjectName()).as("check projectName").isEqualTo(expected.getProjectName()))
            .satisfies(a -> assertThat(a.getProjectState()).as("check projectState").isEqualTo(expected.getProjectState()));
    }
