  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.instructor.home.createOrEditLabel" data-cy="InstructorCreateUpdateHeading">
            <Translate contentKey="ceetApp.instructor.home.createOrEditLabel">Create or edit a Instructor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.instructor.instructorState')}
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceetApp.instructor.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
