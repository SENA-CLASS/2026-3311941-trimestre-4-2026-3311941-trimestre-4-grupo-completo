  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.observationResponse.home.createOrEditLabel" data-cy="ObservationResponseCreateUpdateHeading">
            <Translate contentKey="ceetApp.observationResponse.home.createOrEditLabel">Create or edit a ObservationResponse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.observationResponse.numberObservation')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.observationResponse.obsevation')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.observationResponse.juries')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.observationResponse.dateObservation')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.observationResponse.groupResponse')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceetApp.observationResponse.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
