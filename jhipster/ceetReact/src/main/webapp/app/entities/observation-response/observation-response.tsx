  ...
  return (
    <div>
      <h2 id="observation-response-heading" data-cy="ObservationResponseHeading">
        <Translate contentKey="ceetApp.observationResponse.home.title">Observation Responses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.observationResponse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="ceetApp.observationResponse.home.createLabel">Create new Observation Response</Translate>
          </Link>
        </div>
      </h2>
        ...
        {observationResponseList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.observationResponse.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="ceetApp.observationResponse.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.observationResponse.home.notFound">No Observation Responses found</Translate>
            </div>
          )
        )}
      </div>
