  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.documentType.home.createOrEditLabel" data-cy="DocumentTypeCreateUpdateHeading">
            <Translate contentKey="ceetApp.documentType.home.createOrEditLabel">Create or edit a DocumentType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.documentType.initials')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.documentType.documentName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.documentType.stateDocumentType')}
