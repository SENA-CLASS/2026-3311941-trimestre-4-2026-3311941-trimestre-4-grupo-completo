...
import reducer, {
  ...
  reset,
  updateEntity,
} from './bounding-schedule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUNDINGSCHEDULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUNDINGSCHEDULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUNDINGSCHEDULE actions', async () => {
      const arg = { id: '502b7832-a5bd-4dc7-abd9-e94d122443a9' };
    ...
    it('dispatches UPDATE_BOUNDINGSCHEDULE actions', async () => {
      const arg = { id: '502b7832-a5bd-4dc7-abd9-e94d122443a9' };
    ...
    it('dispatches PARTIAL_UPDATE_BOUNDINGSCHEDULE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BOUNDINGSCHEDULE actions', async () => {
      const arg = 42666;
