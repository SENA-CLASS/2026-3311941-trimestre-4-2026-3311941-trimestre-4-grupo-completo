  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.classroomLimitation.home.createOrEditLabel" data-cy="ClassroomLimitationCreateUpdateHeading">
            <Translate contentKey="ceetApp.classroomLimitation.home.createOrEditLabel">Create or edit a ClassroomLimitation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="classroom"
                data-cy="classroom"
                label={translate('ceetApp.classroomLimitation.classroom')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.classroomLimitation.learningResult')}
                type="select"
                required
              >
                <option value="" key="0" />
