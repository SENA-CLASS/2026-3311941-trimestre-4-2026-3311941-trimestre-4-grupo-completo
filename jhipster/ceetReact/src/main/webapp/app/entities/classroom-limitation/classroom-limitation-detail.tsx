    ...
    <Row>
      <Col md="8">
        <h2 data-cy="classroomLimitationDetailsHeading">
          <Translate contentKey="ceetApp.classroomLimitation.detail.title">ClassroomLimitation</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.classroomLimitation.classroom">Classroom</Translate>
          </dt>
