...
import reducer, {
  ...
  reset,
  updateEntity,
} from './classroom-limitation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSROOMLIMITATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSROOMLIMITATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSROOMLIMITATION actions', async () => {
      const arg = { id: 'abd0e7a4-53e9-4b22-8fb3-9883ceed36ea' };
    ...
    it('dispatches UPDATE_CLASSROOMLIMITATION actions', async () => {
      const arg = { id: 'abd0e7a4-53e9-4b22-8fb3-9883ceed36ea' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSROOMLIMITATION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSROOMLIMITATION actions', async () => {
      const arg = 42666;
