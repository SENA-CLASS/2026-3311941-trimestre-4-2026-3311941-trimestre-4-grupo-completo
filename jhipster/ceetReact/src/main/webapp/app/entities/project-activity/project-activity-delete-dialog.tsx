...
export const ProjectActivityDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceetApp.projectActivity.delete.question">
        <Translate contentKey="ceetApp.projectActivity.delete.question" interpolate={{ id: projectActivityEntity.id }}>
