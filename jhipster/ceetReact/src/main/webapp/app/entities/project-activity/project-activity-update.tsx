  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.projectActivity.home.createOrEditLabel" data-cy="ProjectActivityCreateUpdateHeading">
            <Translate contentKey="ceetApp.projectActivity.home.createOrEditLabel">Create or edit a ProjectActivity</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.projectActivity.activityNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.projectActivity.activityDescription')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.projectActivity.projectActivityState')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.projectActivity.projectPhase')}
                type="select"
                required
              >
                <option value="" key="0" />
