  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.coursePlanning.home.createOrEditLabel" data-cy="CoursePlanningCreateUpdateHeading">
            <Translate contentKey="ceetApp.coursePlanning.home.createOrEditLabel">Create or edit a CoursePlanning</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.coursePlanning.stateCoursePlanning')}
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('ceetApp.coursePlanning.course')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="planning"
                data-cy="planning"
                label={translate('ceetApp.coursePlanning.planning')}
                type="select"
                required
              >
                <option value="" key="0" />
