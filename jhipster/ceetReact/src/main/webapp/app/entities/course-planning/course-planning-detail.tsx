    ...
    <Row>
      <Col md="8">
        <h2 data-cy="coursePlanningDetailsHeading">
          <Translate contentKey="ceetApp.coursePlanning.detail.title">CoursePlanning</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.coursePlanning.course">Course</Translate>
          </dt>
          <dd>{coursePlanningEntity.course ? coursePlanningEntity.course.courseNumber : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.coursePlanning.planning">Planning</Translate>
          </dt>
