  ...
  return (
    <div>
      <h2 id="course-planning-heading" data-cy="CoursePlanningHeading">
        <Translate contentKey="ceetApp.coursePlanning.home.title">Course Plannings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.coursePlanning.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/course-planning/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceetApp.coursePlanning.home.createLabel">Create new Course Planning</Translate>
          </Link>
        </div>
      </h2>
        ...
        {coursePlanningList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.coursePlanning.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('stateCoursePlanning')}>
                  <Translate contentKey="ceetApp.coursePlanning.stateCoursePlanning">State Course Planning</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('stateCoursePlanning')} />
                </th>
                <th>
                  <Translate contentKey="ceetApp.coursePlanning.course">Course</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceetApp.coursePlanning.planning">Planning</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {coursePlanningList.map(coursePlanning => (
                <tr key={`entity-${coursePlanning.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceetApp.State.${coursePlanning.stateCoursePlanning}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.coursePlanning.home.notFound">No Course Plannings found</Translate>
            </div>
          )
        )}
      </div>
