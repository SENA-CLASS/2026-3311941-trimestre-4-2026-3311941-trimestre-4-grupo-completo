    ...
    <Row>
      <Col md="8">
        <h2 data-cy="scheduleVersionDetailsHeading">
          <Translate contentKey="ceetApp.scheduleVersion.detail.title">ScheduleVersion</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.scheduleVersion.currentQuarter">Current Quarter</Translate>
          </dt>
