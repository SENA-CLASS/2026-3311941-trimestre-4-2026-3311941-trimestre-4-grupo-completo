...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULEVERSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEDULEVERSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEDULEVERSION actions', async () => {
      const arg = { id: 'a7abaf4d-38ad-4254-b144-1421e43d3397' };
    ...
    it('dispatches UPDATE_SCHEDULEVERSION actions', async () => {
      const arg = { id: 'a7abaf4d-38ad-4254-b144-1421e43d3397' };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULEVERSION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_SCHEDULEVERSION actions', async () => {
      const arg = 42666;
