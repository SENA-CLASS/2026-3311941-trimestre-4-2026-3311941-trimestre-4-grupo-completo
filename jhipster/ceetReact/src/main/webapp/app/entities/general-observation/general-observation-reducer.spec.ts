...
import reducer, {
  ...
  reset,
  updateEntity,
} from './general-observation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERALOBSERVATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENERALOBSERVATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENERALOBSERVATION actions', async () => {
      const arg = { id: '19f579cb-3eb3-4f57-b243-9eea32539920' };
    ...
    it('dispatches UPDATE_GENERALOBSERVATION actions', async () => {
      const arg = { id: '19f579cb-3eb3-4f57-b243-9eea32539920' };
    ...
    it('dispatches PARTIAL_UPDATE_GENERALOBSERVATION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_GENERALOBSERVATION actions', async () => {
      const arg = 42666;
