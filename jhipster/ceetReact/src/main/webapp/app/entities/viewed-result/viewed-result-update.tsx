  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.viewedResult.home.createOrEditLabel" data-cy="ViewedResultCreateUpdateHeading">
            <Translate contentKey="ceetApp.viewedResult.home.createOrEditLabel">Create or edit a ViewedResult</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.viewedResult.courseTrimester')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="planning"
                data-cy="planning"
                label={translate('ceetApp.viewedResult.planning')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.viewedResult.learningResult')}
                type="select"
                required
              >
                <option value="" key="0" />
