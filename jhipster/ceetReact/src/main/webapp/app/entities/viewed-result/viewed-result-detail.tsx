    ...
    <Row>
      <Col md="8">
        <h2 data-cy="viewedResultDetailsHeading">
          <Translate contentKey="ceetApp.viewedResult.detail.title">ViewedResult</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.viewedResult.courseTrimester">Course Trimester</Translate>
          </dt>
          <dd>{viewedResultEntity.courseTrimester ? viewedResultEntity.courseTrimester.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.viewedResult.planning">Planning</Translate>
          </dt>
          <dd>{viewedResultEntity.planning ? viewedResultEntity.planning.planningCode : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.viewedResult.learningResult">Learning Result</Translate>
          </dt>
