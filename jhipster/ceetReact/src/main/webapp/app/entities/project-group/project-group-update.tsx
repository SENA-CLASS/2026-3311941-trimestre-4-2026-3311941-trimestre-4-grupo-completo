  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.projectGroup.home.createOrEditLabel" data-cy="ProjectGroupCreateUpdateHeading">
            <Translate contentKey="ceetApp.projectGroup.home.createOrEditLabel">Create or edit a ProjectGroup</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.projectGroup.groupNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.projectGroup.projectName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.projectGroup.projectGroupState')}
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('ceetApp.projectGroup.course')}
                type="select"
                required
              >
                <option value="" key="0" />
