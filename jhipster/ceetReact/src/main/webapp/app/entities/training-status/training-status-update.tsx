  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.trainingStatus.home.createOrEditLabel" data-cy="TrainingStatusCreateUpdateHeading">
            <Translate contentKey="ceetApp.trainingStatus.home.createOrEditLabel">Create or edit a TrainingStatus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.trainingStatus.statusName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trainingStatus.stateTraining')}
