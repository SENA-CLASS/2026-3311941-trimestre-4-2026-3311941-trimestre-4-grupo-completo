...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './bonding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BONDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BONDING actions', async () => {
      const arg = { id: 'c7a8c508-c7aa-40be-9cbe-abb77ff018ba' };
    ...
    it('dispatches UPDATE_BONDING actions', async () => {
      const arg = { id: 'c7a8c508-c7aa-40be-9cbe-abb77ff018ba' };
    ...
    it('dispatches PARTIAL_UPDATE_BONDING actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BONDING actions', async () => {
      const arg = 42666;
