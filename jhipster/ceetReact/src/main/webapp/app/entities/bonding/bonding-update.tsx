  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.bonding.home.createOrEditLabel" data-cy="BondingCreateUpdateHeading">
            <Translate contentKey="ceetApp.bonding.home.createOrEditLabel">Create or edit a Bonding</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.bonding.bondingType')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.bonding.workingHours')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.bonding.bondingState')}
