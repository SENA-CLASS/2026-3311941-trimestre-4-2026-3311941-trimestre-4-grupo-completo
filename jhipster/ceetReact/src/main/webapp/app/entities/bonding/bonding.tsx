  ...
  return (
    <div>
      <h2 id="bonding-heading" data-cy="BondingHeading">
        <Translate contentKey="ceetApp.bonding.home.title">Bondings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.bonding.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/bonding/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ceetApp.bonding.home.createLabel">Create new Bonding</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bondingList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.bonding.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
            ...
            <tbody>
              {bondingList.map(bonding => (
                <tr key={`entity-${bonding.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceetApp.State.${bonding.bondingState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.bonding.home.notFound">No Bondings found</Translate>
            </div>
          )
        )}
      </div>
