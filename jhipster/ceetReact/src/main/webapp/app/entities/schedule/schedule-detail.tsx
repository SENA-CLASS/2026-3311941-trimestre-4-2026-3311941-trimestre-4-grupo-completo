    ...
    <Row>
      <Col md="8">
        <h2 data-cy="scheduleDetailsHeading">
          <Translate contentKey="ceetApp.schedule.detail.title">Schedule</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.schedule.scheduleVersion">Schedule Version</Translate>
          </dt>
          <dd>{scheduleEntity.scheduleVersion ? scheduleEntity.scheduleVersion.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.schedule.modality">Modality</Translate>
          </dt>
          <dd>{scheduleEntity.modality ? scheduleEntity.modality.modalityName : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.schedule.day">Day</Translate>
          </dt>
          <dd>{scheduleEntity.day ? scheduleEntity.day.dayName : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.schedule.courseTrimester">Course Trimester</Translate>
          </dt>
          <dd>{scheduleEntity.courseTrimester ? scheduleEntity.courseTrimester.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.schedule.classroom">Classroom</Translate>
          </dt>
          <dd>{scheduleEntity.classroom ? scheduleEntity.classroom.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.schedule.instructor">Instructor</Translate>
          </dt>
