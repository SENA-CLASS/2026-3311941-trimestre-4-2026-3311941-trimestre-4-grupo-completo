...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUARTERSCHEDULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUARTERSCHEDULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUARTERSCHEDULE actions', async () => {
      const arg = { id: '6d26cf65-14a3-450e-b171-5321deb013d8' };
    ...
    it('dispatches UPDATE_QUARTERSCHEDULE actions', async () => {
      const arg = { id: '6d26cf65-14a3-450e-b171-5321deb013d8' };
    ...
    it('dispatches PARTIAL_UPDATE_QUARTERSCHEDULE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_QUARTERSCHEDULE actions', async () => {
      const arg = 42666;
