  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.trimester.home.createOrEditLabel" data-cy="TrimesterCreateUpdateHeading">
            <Translate contentKey="ceetApp.trimester.home.createOrEditLabel">Create or edit a Trimester</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.trimester.trimesterName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trimester.trimesterState')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.trimester.workingDayCourse')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.trimester.levelEducations')}
                type="select"
                required
              >
                <option value="" key="0" />
