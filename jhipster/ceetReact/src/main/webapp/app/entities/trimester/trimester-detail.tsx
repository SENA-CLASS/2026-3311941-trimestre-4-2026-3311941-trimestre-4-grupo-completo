    ...
    <Row>
      <Col md="8">
        <h2 data-cy="trimesterDetailsHeading">
          <Translate contentKey="ceetApp.trimester.detail.title">Trimester</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.trimester.workingDayCourse">Working Day Course</Translate>
          </dt>
          <dd>{trimesterEntity.workingDayCourse ? trimesterEntity.workingDayCourse.workingDayName : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.trimester.levelEducations">Level Educations</Translate>
          </dt>
