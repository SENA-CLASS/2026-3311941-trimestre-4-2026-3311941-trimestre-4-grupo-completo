  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.workingDay.home.createOrEditLabel" data-cy="WorkingDayCreateUpdateHeading">
            <Translate contentKey="ceetApp.workingDay.home.createOrEditLabel">Create or edit a WorkingDay</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.workingDay.startTime')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.workingDay.endTime')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.workingDay.instructorWorkingDay')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="day"
                data-cy="day"
                label={translate('ceetApp.workingDay.day')}
                type="select"
                required
              >
                <option value="" key="0" />
