  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.classroom.home.createOrEditLabel" data-cy="ClassroomCreateUpdateHeading">
            <Translate contentKey="ceetApp.classroom.home.createOrEditLabel">Create or edit a Classroom</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.classroom.classroomNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.classroom.classroomDescription')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.classroom.classroomState')}
              ...
              <ValidatedField
                label={translate('ceetApp.classroom.limitation')}
              ...
              >
                {limitationValues.map(limitation => (
                  <option value={limitation} key={limitation}>
                    {translate(`ceetApp.Limitation.${limitation}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                label={translate('ceetApp.classroom.classroomType')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="campus"
                data-cy="campus"
                label={translate('ceetApp.classroom.campus')}
                type="select"
                required
              >
                <option value="" key="0" />
