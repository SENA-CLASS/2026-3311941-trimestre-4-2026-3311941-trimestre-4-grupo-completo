    ...
    <Row>
      <Col md="8">
        <h2 data-cy="classroomDetailsHeading">
          <Translate contentKey="ceetApp.classroom.detail.title">Classroom</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.classroom.classroomType">Classroom Type</Translate>
          </dt>
          <dd>{classroomEntity.classroomType ? classroomEntity.classroomType.typeClassroom : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.classroom.campus">Campus</Translate>
          </dt>
