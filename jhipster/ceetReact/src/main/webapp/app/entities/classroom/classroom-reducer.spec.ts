...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './classroom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_CLASSROOM actions', async () => {
      const arg = { id: '8ce047e9-4e00-4822-b68d-4115c0d99bb4' };
