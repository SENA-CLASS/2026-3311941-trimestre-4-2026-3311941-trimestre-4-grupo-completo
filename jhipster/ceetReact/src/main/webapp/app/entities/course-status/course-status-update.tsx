  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.courseStatus.home.createOrEditLabel" data-cy="CourseStatusCreateUpdateHeading">
            <Translate contentKey="ceetApp.courseStatus.home.createOrEditLabel">Create or edit a CourseStatus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.courseStatus.nameCourseStatus')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.courseStatus.stateCourse')}
