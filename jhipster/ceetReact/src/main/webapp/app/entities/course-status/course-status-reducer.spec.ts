...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSESTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSESTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSESTATUS actions', async () => {
      const arg = { id: 'ffe39020-1c0d-4cb1-a934-16944daffc5b' };
    ...
    it('dispatches UPDATE_COURSESTATUS actions', async () => {
      const arg = { id: 'ffe39020-1c0d-4cb1-a934-16944daffc5b' };
    ...
    it('dispatches PARTIAL_UPDATE_COURSESTATUS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_COURSESTATUS actions', async () => {
      const arg = 42666;
