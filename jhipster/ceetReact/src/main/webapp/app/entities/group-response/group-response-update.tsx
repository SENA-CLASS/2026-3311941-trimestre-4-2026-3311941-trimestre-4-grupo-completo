  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.groupResponse.home.createOrEditLabel" data-cy="GroupResponseCreateUpdateHeading">
            <Translate contentKey="ceetApp.groupResponse.home.createOrEditLabel">Create or edit a GroupResponse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.groupResponse.evaluationDate')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.groupResponse.projectGroup')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="assessment"
                data-cy="assessment"
                label={translate('ceetApp.groupResponse.assessment')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="itemList"
                data-cy="itemList"
                label={translate('ceetApp.groupResponse.itemList')}
                type="select"
                required
              >
                <option value="" key="0" />
