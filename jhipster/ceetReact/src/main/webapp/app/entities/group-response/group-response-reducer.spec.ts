...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPRESPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GROUPRESPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GROUPRESPONSE actions', async () => {
      const arg = { id: 'e20ecb71-d9ec-4694-82c9-f26362300c8f' };
    ...
    it('dispatches UPDATE_GROUPRESPONSE actions', async () => {
      const arg = { id: 'e20ecb71-d9ec-4694-82c9-f26362300c8f' };
    ...
    it('dispatches PARTIAL_UPDATE_GROUPRESPONSE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_GROUPRESPONSE actions', async () => {
      const arg = 42666;
