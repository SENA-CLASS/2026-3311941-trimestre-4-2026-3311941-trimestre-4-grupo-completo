...
import reducer, {
  ...
  reset,
  updateEntity,
} from './planning-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANNINGACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLANNINGACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLANNINGACTIVITY actions', async () => {
      const arg = { id: '62ae726d-e1bd-43c1-b6e1-2b81a88a5872' };
    ...
    it('dispatches UPDATE_PLANNINGACTIVITY actions', async () => {
      const arg = { id: '62ae726d-e1bd-43c1-b6e1-2b81a88a5872' };
    ...
    it('dispatches PARTIAL_UPDATE_PLANNINGACTIVITY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PLANNINGACTIVITY actions', async () => {
      const arg = 42666;
