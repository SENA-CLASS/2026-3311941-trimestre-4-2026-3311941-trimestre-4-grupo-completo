  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.planningActivity.home.createOrEditLabel" data-cy="PlanningActivityCreateUpdateHeading">
            <Translate contentKey="ceetApp.planningActivity.home.createOrEditLabel">Create or edit a PlanningActivity</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.planningActivity.quarterSchedule')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.planningActivity.projectActivity')}
                type="select"
                required
              >
                <option value="" key="0" />
