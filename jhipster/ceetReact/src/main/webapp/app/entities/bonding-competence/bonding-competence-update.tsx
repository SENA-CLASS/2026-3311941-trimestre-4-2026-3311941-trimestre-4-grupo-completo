  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.bondingCompetence.home.createOrEditLabel" data-cy="BondingCompetenceCreateUpdateHeading">
            <Translate contentKey="ceetApp.bondingCompetence.home.createOrEditLabel">Create or edit a BondingCompetence</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.bondingCompetence.bondingInstructor')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.bondingCompetence.learningCompetence')}
                type="select"
                required
              >
                <option value="" key="0" />
