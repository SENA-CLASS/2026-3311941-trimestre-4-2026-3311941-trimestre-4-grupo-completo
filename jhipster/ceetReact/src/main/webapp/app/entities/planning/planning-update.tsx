  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.planning.home.createOrEditLabel" data-cy="PlanningCreateUpdateHeading">
            <Translate contentKey="ceetApp.planning.home.createOrEditLabel">Create or edit a Planning</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.planning.planningCode')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.planning.planningDate')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.planning.planningState')}
