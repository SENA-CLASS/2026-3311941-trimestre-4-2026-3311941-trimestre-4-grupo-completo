...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './log-error.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGERROR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOGERROR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOGERROR actions', async () => {
      const arg = { id: '5cc22e6b-06ac-42d0-a1ab-fed31ace05cd' };
    ...
    it('dispatches UPDATE_LOGERROR actions', async () => {
      const arg = { id: '5cc22e6b-06ac-42d0-a1ab-fed31ace05cd' };
    ...
    it('dispatches PARTIAL_UPDATE_LOGERROR actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LOGERROR actions', async () => {
      const arg = 42666;
