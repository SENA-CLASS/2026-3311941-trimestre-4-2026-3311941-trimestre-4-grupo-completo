  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.logError.home.createOrEditLabel" data-cy="LogErrorCreateUpdateHeading">
            <Translate contentKey="ceetApp.logError.home.createOrEditLabel">Create or edit a LogError</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.logError.levelError')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.logError.logName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.logError.messageError')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.logError.dateError')}
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceetApp.logError.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
