    ...
    <Row>
      <Col md="8">
        <h2 data-cy="customerDetailsHeading">
          <Translate contentKey="ceetApp.customer.detail.title">Customer</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.customer.user">User</Translate>
          </dt>
          <dd>{customerEntity.user ? customerEntity.user.login : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.customer.documentType">Document Type</Translate>
          </dt>
