...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSETRIMESTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSETRIMESTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSETRIMESTER actions', async () => {
      const arg = { id: '160fb1c3-2c69-4184-ab10-636c5d1d30b8' };
    ...
    it('dispatches UPDATE_COURSETRIMESTER actions', async () => {
      const arg = { id: '160fb1c3-2c69-4184-ab10-636c5d1d30b8' };
    ...
    it('dispatches PARTIAL_UPDATE_COURSETRIMESTER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_COURSETRIMESTER actions', async () => {
      const arg = 42666;
