  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.courseTrimester.home.createOrEditLabel" data-cy="CourseTrimesterCreateUpdateHeading">
            <Translate contentKey="ceetApp.courseTrimester.home.createOrEditLabel">Create or edit a CourseTrimester</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('ceetApp.courseTrimester.course')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="trimester"
                data-cy="trimester"
                label={translate('ceetApp.courseTrimester.trimester')}
                type="select"
                required
              >
                <option value="" key="0" />
