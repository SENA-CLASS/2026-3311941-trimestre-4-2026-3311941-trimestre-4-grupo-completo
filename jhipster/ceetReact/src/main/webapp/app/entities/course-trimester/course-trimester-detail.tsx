    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseTrimesterDetailsHeading">
          <Translate contentKey="ceetApp.courseTrimester.detail.title">CourseTrimester</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.courseTrimester.course">Course</Translate>
          </dt>
          <dd>{courseTrimesterEntity.course ? courseTrimesterEntity.course.courseNumber : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.courseTrimester.trimester">Trimester</Translate>
          </dt>
