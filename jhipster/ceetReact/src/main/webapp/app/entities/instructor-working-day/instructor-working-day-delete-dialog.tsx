...
export const InstructorWorkingDayDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceetApp.instructorWorkingDay.delete.question">
        <Translate contentKey="ceetApp.instructorWorkingDay.delete.question" interpolate={{ id: instructorWorkingDayEntity.id }}>
