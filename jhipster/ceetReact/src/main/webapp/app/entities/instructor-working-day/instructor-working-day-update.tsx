  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.instructorWorkingDay.home.createOrEditLabel" data-cy="InstructorWorkingDayCreateUpdateHeading">
            <Translate contentKey="ceetApp.instructorWorkingDay.home.createOrEditLabel">Create or edit a InstructorWorkingDay</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.instructorWorkingDay.nameWorkingDay')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.instructorWorkingDay.descriptionWorkingDay')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.instructorWorkingDay.workingDayState')}
