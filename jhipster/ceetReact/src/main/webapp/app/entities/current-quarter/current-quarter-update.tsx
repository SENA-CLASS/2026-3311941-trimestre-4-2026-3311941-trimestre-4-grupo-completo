  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.currentQuarter.home.createOrEditLabel" data-cy="CurrentQuarterCreateUpdateHeading">
            <Translate contentKey="ceetApp.currentQuarter.home.createOrEditLabel">Create or edit a CurrentQuarter</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.currentQuarter.scheduledQuarter')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.currentQuarter.startQuarter')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.currentQuarter.endQuarter')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.currentQuarter.currentQuarterState')}
              ...
              <ValidatedField
                ...
                name="year"
                data-cy="year"
                label={translate('ceetApp.currentQuarter.year')}
                type="select"
                required
              >
                <option value="" key="0" />
