  ...
  return (
    <div>
      <h2 id="current-quarter-heading" data-cy="CurrentQuarterHeading">
        <Translate contentKey="ceetApp.currentQuarter.home.title">Current Quarters</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.currentQuarter.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/current-quarter/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceetApp.currentQuarter.home.createLabel">Create new Current Quarter</Translate>
          </Link>
        </div>
      </h2>
        ...
        {currentQuarterList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.currentQuarter.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="ceetApp.currentQuarter.year">Year</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {currentQuarterList.map(currentQuarter => (
                <tr key={`entity-${currentQuarter.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceetApp.State.${currentQuarter.currentQuarterState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.currentQuarter.home.notFound">No Current Quarters found</Translate>
            </div>
          )
        )}
      </div>
