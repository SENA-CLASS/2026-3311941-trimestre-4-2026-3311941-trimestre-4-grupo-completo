  ...
  return (
    <div>
      <h2 id="bonding-instructor-heading" data-cy="BondingInstructorHeading">
        <Translate contentKey="ceetApp.bondingInstructor.home.title">Bonding Instructors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.bondingInstructor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="ceetApp.bondingInstructor.home.createLabel">Create new Bonding Instructor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bondingInstructorList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.bondingInstructor.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="ceetApp.bondingInstructor.year">Year</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceetApp.bondingInstructor.instructor">Instructor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceetApp.bondingInstructor.bonding">Bonding</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.bondingInstructor.home.notFound">No Bonding Instructors found</Translate>
            </div>
          )
        )}
      </div>
