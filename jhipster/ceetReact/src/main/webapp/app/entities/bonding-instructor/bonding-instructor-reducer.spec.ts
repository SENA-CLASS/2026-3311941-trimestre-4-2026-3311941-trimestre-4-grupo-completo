...
import reducer, {
  ...
  reset,
  updateEntity,
} from './bonding-instructor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONDINGINSTRUCTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BONDINGINSTRUCTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BONDINGINSTRUCTOR actions', async () => {
      const arg = { id: 'b53dd849-590c-4532-8f92-15e5623948e6' };
    ...
    it('dispatches UPDATE_BONDINGINSTRUCTOR actions', async () => {
      const arg = { id: 'b53dd849-590c-4532-8f92-15e5623948e6' };
    ...
    it('dispatches PARTIAL_UPDATE_BONDINGINSTRUCTOR actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BONDINGINSTRUCTOR actions', async () => {
      const arg = 42666;
