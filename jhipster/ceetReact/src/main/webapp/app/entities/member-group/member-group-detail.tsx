    ...
    <Row>
      <Col md="8">
        <h2 data-cy="memberGroupDetailsHeading">
          <Translate contentKey="ceetApp.memberGroup.detail.title">MemberGroup</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.memberGroup.projectGroup">Project Group</Translate>
          </dt>
          <dd>{memberGroupEntity.projectGroup ? memberGroupEntity.projectGroup.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.memberGroup.apprentice">Apprentice</Translate>
          </dt>
