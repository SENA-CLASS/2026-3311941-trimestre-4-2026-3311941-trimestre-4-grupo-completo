...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEMBERGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEMBERGROUP actions', async () => {
      const arg = { id: 'c2a1fa14-445f-49f5-ba37-551635dc0bb3' };
    ...
    it('dispatches UPDATE_MEMBERGROUP actions', async () => {
      const arg = { id: 'c2a1fa14-445f-49f5-ba37-551635dc0bb3' };
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERGROUP actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MEMBERGROUP actions', async () => {
      const arg = 42666;
