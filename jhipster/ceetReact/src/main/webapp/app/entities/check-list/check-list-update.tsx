  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.checkList.home.createOrEditLabel" data-cy="CheckListCreateUpdateHeading">
            <Translate contentKey="ceetApp.checkList.home.createOrEditLabel">Create or edit a CheckList</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.checkList.listName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.checkList.listState')}
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.checkList.trainingProgram')}
                type="select"
                required
              >
                <option value="" key="0" />
