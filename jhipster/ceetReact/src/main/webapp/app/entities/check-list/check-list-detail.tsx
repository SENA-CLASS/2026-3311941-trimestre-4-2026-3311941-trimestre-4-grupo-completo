    ...
    <Row>
      <Col md="8">
        <h2 data-cy="checkListDetailsHeading">
          <Translate contentKey="ceetApp.checkList.detail.title">CheckList</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="listName">
              <Translate contentKey="ceetApp.checkList.listName">List Name</Translate>
            </span>
          </dt>
          <dd>{checkListEntity.listName}</dd>
          <dt>
            <span id="listState">
              <Translate contentKey="ceetApp.checkList.listState">List State</Translate>
            </span>
          </dt>
          <dd>{checkListEntity.listState}</dd>
          <dt>
            <Translate contentKey="ceetApp.checkList.trainingProgram">Training Program</Translate>
          </dt>
