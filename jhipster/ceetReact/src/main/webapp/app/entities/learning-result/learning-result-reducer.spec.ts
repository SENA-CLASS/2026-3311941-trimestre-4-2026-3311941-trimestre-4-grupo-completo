...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNINGRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEARNINGRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEARNINGRESULT actions', async () => {
      const arg = { id: '18957aee-fabd-42ae-ac8b-2f943a81490c' };
    ...
    it('dispatches UPDATE_LEARNINGRESULT actions', async () => {
      const arg = { id: '18957aee-fabd-42ae-ac8b-2f943a81490c' };
    ...
    it('dispatches PARTIAL_UPDATE_LEARNINGRESULT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LEARNINGRESULT actions', async () => {
      const arg = 42666;
