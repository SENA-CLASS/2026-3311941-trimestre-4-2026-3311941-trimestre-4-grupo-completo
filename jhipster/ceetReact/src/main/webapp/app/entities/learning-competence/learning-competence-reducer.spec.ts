...
import reducer, {
  ...
  reset,
  updateEntity,
} from './learning-competence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNINGCOMPETENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEARNINGCOMPETENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEARNINGCOMPETENCE actions', async () => {
      const arg = { id: '3aea7988-06c6-469f-ac06-f7b3b58ed0b7' };
    ...
    it('dispatches UPDATE_LEARNINGCOMPETENCE actions', async () => {
      const arg = { id: '3aea7988-06c6-469f-ac06-f7b3b58ed0b7' };
    ...
    it('dispatches PARTIAL_UPDATE_LEARNINGCOMPETENCE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LEARNINGCOMPETENCE actions', async () => {
      const arg = 42666;
