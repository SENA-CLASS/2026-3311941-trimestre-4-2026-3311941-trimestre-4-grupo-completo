    ...
    <Row>
      <Col md="8">
        <h2 data-cy="areaInstructorDetailsHeading">
          <Translate contentKey="ceetApp.areaInstructor.detail.title">AreaInstructor</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.areaInstructor.area">Area</Translate>
          </dt>
          <dd>{areaInstructorEntity.area ? areaInstructorEntity.area.areaName : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.areaInstructor.instructor">Instructor</Translate>
          </dt>
