...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AREAINSTRUCTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AREAINSTRUCTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AREAINSTRUCTOR actions', async () => {
      const arg = { id: 'fb11d601-b709-4616-aaa1-0d126f7bd657' };
    ...
    it('dispatches UPDATE_AREAINSTRUCTOR actions', async () => {
      const arg = { id: 'fb11d601-b709-4616-aaa1-0d126f7bd657' };
    ...
    it('dispatches PARTIAL_UPDATE_AREAINSTRUCTOR actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_AREAINSTRUCTOR actions', async () => {
      const arg = 42666;
