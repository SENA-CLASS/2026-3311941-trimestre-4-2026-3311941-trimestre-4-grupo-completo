  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.itemList.home.createOrEditLabel" data-cy="ItemListCreateUpdateHeading">
            <Translate contentKey="ceetApp.itemList.home.createOrEditLabel">Create or edit a ItemList</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.itemList.itemNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.itemList.question')}
              ...
              <ValidatedField
                ...
                name="checkList"
                data-cy="checkList"
                label={translate('ceetApp.itemList.checkList')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceetApp.itemList.learningResult')}
                type="select"
                required
              >
                <option value="" key="0" />
