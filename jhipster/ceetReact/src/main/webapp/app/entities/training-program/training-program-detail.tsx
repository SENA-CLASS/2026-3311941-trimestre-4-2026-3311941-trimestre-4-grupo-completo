    ...
    <Row>
      <Col md="8">
        <h2 data-cy="trainingProgramDetailsHeading">
          <Translate contentKey="ceetApp.trainingProgram.detail.title">TrainingProgram</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.trainingProgram.levelEducation">Level Education</Translate>
          </dt>
