  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.trainingProgram.home.createOrEditLabel" data-cy="TrainingProgramCreateUpdateHeading">
            <Translate contentKey="ceetApp.trainingProgram.home.createOrEditLabel">Create or edit a TrainingProgram</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.trainingProgram.programCode')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trainingProgram.programVersion')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trainingProgram.programName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trainingProgram.programInitials')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.trainingProgram.programState')}
              ...
              >
                {stateProgramValues.map(stateProgram => (
                  <option value={stateProgram} key={stateProgram}>
                    {translate(`ceetApp.StateProgram.${stateProgram}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                label={translate('ceetApp.trainingProgram.levelEducation')}
                type="select"
                required
              >
                <option value="" key="0" />
