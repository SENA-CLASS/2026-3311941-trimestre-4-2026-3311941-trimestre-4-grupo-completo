  ...
  return (
    <div>
      <h2 id="log-audit-heading" data-cy="LogAuditHeading">
        <Translate contentKey="ceetApp.logAudit.home.title">Log Audits</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.logAudit.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/log-audit/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ceetApp.logAudit.home.createLabel">Create new Log Audit</Translate>
          </Link>
        </div>
      </h2>
        ...
        {logAuditList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.logAudit.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('levelAudit')}>
                  <Translate contentKey="ceetApp.logAudit.levelAudit">Level Audit</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('levelAudit')} />
                </th>
                <th className="hand" onClick={sort('logName')}>
                  <Translate contentKey="ceetApp.logAudit.logName">Log Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('logName')} />
                </th>
                <th className="hand" onClick={sort('messageAudit')}>
                  <Translate contentKey="ceetApp.logAudit.messageAudit">Message Audit</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('messageAudit')} />
                </th>
                <th className="hand" onClick={sort('dateAudit')}>
                  <Translate contentKey="ceetApp.logAudit.dateAudit">Date Audit</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('dateAudit')} />
                </th>
                <th>
                  <Translate contentKey="ceetApp.logAudit.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.logAudit.home.notFound">No Log Audits found</Translate>
            </div>
          )
        )}
      </div>
