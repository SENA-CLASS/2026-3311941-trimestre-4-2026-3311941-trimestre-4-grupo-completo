...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVELEDUCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEVELEDUCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEVELEDUCATION actions', async () => {
      const arg = { id: 'da387bdf-5e02-4940-8409-2be6a4f3a50c' };
    ...
    it('dispatches UPDATE_LEVELEDUCATION actions', async () => {
      const arg = { id: 'da387bdf-5e02-4940-8409-2be6a4f3a50c' };
    ...
    it('dispatches PARTIAL_UPDATE_LEVELEDUCATION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LEVELEDUCATION actions', async () => {
      const arg = 42666;
