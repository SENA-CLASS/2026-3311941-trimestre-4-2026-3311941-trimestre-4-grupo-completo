  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.levelEducation.home.createOrEditLabel" data-cy="LevelEducationCreateUpdateHeading">
            <Translate contentKey="ceetApp.levelEducation.home.createOrEditLabel">Create or edit a LevelEducation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.levelEducation.levelName')}
              ...
              />
              <ValidatedField
                label={translate('ceetApp.levelEducation.stateLevelEducation')}
