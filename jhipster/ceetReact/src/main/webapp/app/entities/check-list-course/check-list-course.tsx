  ...
  return (
    <div>
      <h2 id="check-list-course-heading" data-cy="CheckListCourseHeading">
        <Translate contentKey="ceetApp.checkListCourse.home.title">Check List Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceetApp.checkListCourse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/check-list-course/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceetApp.checkListCourse.home.createLabel">Create new Check List Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {checkListCourseList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceetApp.checkListCourse.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('checkListState')}>
                  <Translate contentKey="ceetApp.checkListCourse.checkListState">Check List State</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('checkListState')} />
                </th>
                <th>
                  <Translate contentKey="ceetApp.checkListCourse.course">Course</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceetApp.checkListCourse.checkList">Check List</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {checkListCourseList.map(checkListCourse => (
                <tr key={`entity-${checkListCourse.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceetApp.State.${checkListCourse.checkListState}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceetApp.checkListCourse.home.notFound">No Check List Courses found</Translate>
            </div>
          )
        )}
      </div>
