  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceetApp.checkListCourse.home.createOrEditLabel" data-cy="CheckListCourseCreateUpdateHeading">
            <Translate contentKey="ceetApp.checkListCourse.home.createOrEditLabel">Create or edit a CheckListCourse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceetApp.checkListCourse.checkListState')}
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('ceetApp.checkListCourse.course')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="checkList"
                data-cy="checkList"
                label={translate('ceetApp.checkListCourse.checkList')}
                type="select"
                required
              >
                <option value="" key="0" />
