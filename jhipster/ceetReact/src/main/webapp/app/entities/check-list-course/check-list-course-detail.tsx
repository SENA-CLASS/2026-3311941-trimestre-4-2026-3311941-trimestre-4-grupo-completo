    ...
    <Row>
      <Col md="8">
        <h2 data-cy="checkListCourseDetailsHeading">
          <Translate contentKey="ceetApp.checkListCourse.detail.title">CheckListCourse</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceetApp.checkListCourse.course">Course</Translate>
          </dt>
          <dd>{checkListCourseEntity.course ? checkListCourseEntity.course.id : ''}</dd>
          <dt>
            <Translate contentKey="ceetApp.checkListCourse.checkList">Check List</Translate>
          </dt>
