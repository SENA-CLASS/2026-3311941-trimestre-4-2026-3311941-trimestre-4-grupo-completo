...
export const ScheduleVersionDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.scheduleVersion.delete.question">
        <Translate contentKey="ceet2App.scheduleVersion.delete.question" interpolate={{ id: scheduleVersionEntity.id }}>
