  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.scheduleVersion.home.createOrEditLabel" data-cy="ScheduleVersionCreateUpdateHeading">
            <Translate contentKey="ceet2App.scheduleVersion.home.createOrEditLabel">Create or edit a ScheduleVersion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.scheduleVersion.versionNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.scheduleVersion.versionState')}
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.scheduleVersion.currentQuarter')}
                type="select"
                required
              >
                <option value="" key="0" />
