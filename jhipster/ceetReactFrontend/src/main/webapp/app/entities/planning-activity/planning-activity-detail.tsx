    ...
    <Row>
      <Col md="8">
        <h2 data-cy="planningActivityDetailsHeading">
          <Translate contentKey="ceet2App.planningActivity.detail.title">PlanningActivity</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.planningActivity.quarterSchedule">Quarter Schedule</Translate>
          </dt>
          <dd>{planningActivityEntity.quarterSchedule ? planningActivityEntity.quarterSchedule.id : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.planningActivity.projectActivity">Project Activity</Translate>
          </dt>
