...
import reducer, {
  ...
  reset,
  updateEntity,
} from './instructor-working-day.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTRUCTORWORKINGDAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTRUCTORWORKINGDAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTRUCTORWORKINGDAY actions', async () => {
      const arg = { id: 'ecdc811d-5dbd-4900-9650-efc8cb17608a' };
    ...
    it('dispatches UPDATE_INSTRUCTORWORKINGDAY actions', async () => {
      const arg = { id: 'ecdc811d-5dbd-4900-9650-efc8cb17608a' };
    ...
    it('dispatches PARTIAL_UPDATE_INSTRUCTORWORKINGDAY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_INSTRUCTORWORKINGDAY actions', async () => {
      const arg = 42666;
