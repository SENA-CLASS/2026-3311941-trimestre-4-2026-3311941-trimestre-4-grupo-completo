  ...
  return (
    <div>
      <h2 id="instructor-working-day-heading" data-cy="InstructorWorkingDayHeading">
        <Translate contentKey="ceet2App.instructorWorkingDay.home.title">Instructor Working Days</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.instructorWorkingDay.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="ceet2App.instructorWorkingDay.home.createLabel">Create new Instructor Working Day</Translate>
          </Link>
        </div>
      </h2>
        ...
        {instructorWorkingDayList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.instructorWorkingDay.id">ID</Translate>{' '}
            ...
            <tbody>
              {instructorWorkingDayList.map(instructorWorkingDay => (
                <tr key={`entity-${instructorWorkingDay.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceet2App.State.${instructorWorkingDay.workingDayState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.instructorWorkingDay.home.notFound">No Instructor Working Days found</Translate>
            </div>
          )
        )}
      </div>
