  ...
  return (
    <div>
      <h2 id="group-response-heading" data-cy="GroupResponseHeading">
        <Translate contentKey="ceet2App.groupResponse.home.title">Group Responses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.groupResponse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/group-response/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceet2App.groupResponse.home.createLabel">Create new Group Response</Translate>
          </Link>
        </div>
      </h2>
        ...
        {groupResponseList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.groupResponse.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('evaluationDate')}>
                  <Translate contentKey="ceet2App.groupResponse.evaluationDate">Evaluation Date</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('evaluationDate')} />
                </th>
                <th>
                  <Translate contentKey="ceet2App.groupResponse.projectGroup">Project Group</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.groupResponse.assessment">Assessment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.groupResponse.itemList">Item List</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.groupResponse.home.notFound">No Group Responses found</Translate>
            </div>
          )
        )}
      </div>
