    ...
    <Row>
      <Col md="8">
        <h2 data-cy="groupResponseDetailsHeading">
          <Translate contentKey="ceet2App.groupResponse.detail.title">GroupResponse</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.groupResponse.projectGroup">Project Group</Translate>
          </dt>
          <dd>{groupResponseEntity.projectGroup ? groupResponseEntity.projectGroup.id : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.groupResponse.assessment">Assessment</Translate>
          </dt>
          <dd>{groupResponseEntity.assessment ? groupResponseEntity.assessment.assessmentType : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.groupResponse.itemList">Item List</Translate>
          </dt>
