  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.campus.home.createOrEditLabel" data-cy="CampusCreateUpdateHeading">
            <Translate contentKey="ceet2App.campus.home.createOrEditLabel">Create or edit a Campus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.campus.campusName')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.campus.campusAddress')}
                id="campus-campusAddress"
                name="campusAddress"
                data-cy="campusAddress"
                type="text"
                validate={{
                  required: { value: true, message: translate('entity.validation.required') },
              ...
              />
              <ValidatedField
                label={translate('ceet2App.campus.campusState')}
                id="campus-campusState"
                name="campusState"
                data-cy="campusState"
                type="select"
              >
