  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.learningCompetence.home.createOrEditLabel" data-cy="LearningCompetenceCreateUpdateHeading">
            <Translate contentKey="ceet2App.learningCompetence.home.createOrEditLabel">Create or edit a LearningCompetence</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.learningCompetence.competenceCode')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.learningCompetence.competitionDenomination')}
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.learningCompetence.trainingProgram')}
                type="select"
                required
              >
                <option value="" key="0" />
