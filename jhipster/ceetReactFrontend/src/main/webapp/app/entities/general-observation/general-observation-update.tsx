  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.generalObservation.home.createOrEditLabel" data-cy="GeneralObservationCreateUpdateHeading">
            <Translate contentKey="ceet2App.generalObservation.home.createOrEditLabel">Create or edit a GeneralObservation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.generalObservation.number')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.generalObservation.observationGeneral')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.generalObservation.jury')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.generalObservation.dateAudit')}
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.generalObservation.projectGroup')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceet2App.generalObservation.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
