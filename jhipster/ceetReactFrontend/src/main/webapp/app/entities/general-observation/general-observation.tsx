  ...
  return (
    <div>
      <h2 id="general-observation-heading" data-cy="GeneralObservationHeading">
        <Translate contentKey="ceet2App.generalObservation.home.title">General Observations</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.generalObservation.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="ceet2App.generalObservation.home.createLabel">Create new General Observation</Translate>
          </Link>
        </div>
      </h2>
        ...
        {generalObservationList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.generalObservation.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('number')}>
                  <Translate contentKey="ceet2App.generalObservation.number">Number</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('number')} />
                </th>
                <th className="hand" onClick={sort('observationGeneral')}>
                  <Translate contentKey="ceet2App.generalObservation.observationGeneral">Observation General</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('observationGeneral')} />
                </th>
                <th className="hand" onClick={sort('jury')}>
                  <Translate contentKey="ceet2App.generalObservation.jury">Jury</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('jury')} />
                </th>
                <th className="hand" onClick={sort('dateAudit')}>
                  <Translate contentKey="ceet2App.generalObservation.dateAudit">Date Audit</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('dateAudit')} />
                </th>
                <th>
                  <Translate contentKey="ceet2App.generalObservation.projectGroup">Project Group</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.generalObservation.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.generalObservation.home.notFound">No General Observations found</Translate>
            </div>
          )
        )}
      </div>
