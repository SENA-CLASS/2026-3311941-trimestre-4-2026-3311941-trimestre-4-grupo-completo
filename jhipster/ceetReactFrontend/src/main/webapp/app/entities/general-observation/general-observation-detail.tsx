    ...
    <Row>
      <Col md="8">
        <h2 data-cy="generalObservationDetailsHeading">
          <Translate contentKey="ceet2App.generalObservation.detail.title">GeneralObservation</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.generalObservation.projectGroup">Project Group</Translate>
          </dt>
          <dd>{generalObservationEntity.projectGroup ? generalObservationEntity.projectGroup.id : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.generalObservation.customer">Customer</Translate>
          </dt>
