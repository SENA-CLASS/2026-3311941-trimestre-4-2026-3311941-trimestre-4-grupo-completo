...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEPLANNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURSEPLANNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURSEPLANNING actions', async () => {
      const arg = { id: '348f1f27-344e-4abf-8109-9ade6238651b' };
    ...
    it('dispatches UPDATE_COURSEPLANNING actions', async () => {
      const arg = { id: '348f1f27-344e-4abf-8109-9ade6238651b' };
    ...
    it('dispatches PARTIAL_UPDATE_COURSEPLANNING actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_COURSEPLANNING actions', async () => {
      const arg = 42666;
