...
export const CoursePlanningDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.coursePlanning.delete.question">
        <Translate contentKey="ceet2App.coursePlanning.delete.question" interpolate={{ id: coursePlanningEntity.id }}>
