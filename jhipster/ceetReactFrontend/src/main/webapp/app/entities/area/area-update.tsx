  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.area.home.createOrEditLabel" data-cy="AreaCreateUpdateHeading">
            <Translate contentKey="ceet2App.area.home.createOrEditLabel">Create or edit a Area</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.area.areaName')}
                id="area-areaName"
                name="areaName"
                data-cy="areaName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.area.urlLogo')}
                id="area-urlLogo"
                name="urlLogo"
                data-cy="urlLogo"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.area.areaState')}
                id="area-areaState"
                name="areaState"
                data-cy="areaState"
                type="select"
