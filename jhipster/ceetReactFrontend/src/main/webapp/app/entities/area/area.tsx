  ...
  return (
    <div>
      <h2 id="area-heading" data-cy="AreaHeading">
        <Translate contentKey="ceet2App.area.home.title">Areas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.area.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/area/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ceet2App.area.home.createLabel">Create new Area</Translate>
          </Link>
        </div>
      </h2>
        ...
        {areaList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.area.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
            ...
            <tbody>
              {areaList.map(area => (
                <tr key={`entity-${area.id}`} data-cy="entityTable">
                  ...
                  <td>{area.urlLogo}</td>
                  <td>
                    <Translate contentKey={`ceet2App.State.${area.areaState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.area.home.notFound">No Areas found</Translate>
            </div>
          )
        )}
      </div>
