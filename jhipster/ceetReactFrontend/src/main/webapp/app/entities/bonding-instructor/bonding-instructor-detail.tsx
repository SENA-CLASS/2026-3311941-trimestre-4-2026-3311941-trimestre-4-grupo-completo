    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bondingInstructorDetailsHeading">
          <Translate contentKey="ceet2App.bondingInstructor.detail.title">BondingInstructor</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.bondingInstructor.year">Year</Translate>
          </dt>
          <dd>{bondingInstructorEntity.year ? bondingInstructorEntity.year.yearNumber : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.bondingInstructor.instructor">Instructor</Translate>
          </dt>
          <dd>{bondingInstructorEntity.instructor ? bondingInstructorEntity.instructor.id : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.bondingInstructor.bonding">Bonding</Translate>
          </dt>
