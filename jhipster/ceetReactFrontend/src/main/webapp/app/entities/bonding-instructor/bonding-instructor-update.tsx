  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.bondingInstructor.home.createOrEditLabel" data-cy="BondingInstructorCreateUpdateHeading">
            <Translate contentKey="ceet2App.bondingInstructor.home.createOrEditLabel">Create or edit a BondingInstructor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.bondingInstructor.startTime')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.bondingInstructor.endTime')}
              ...
              <ValidatedField
                ...
                name="year"
                data-cy="year"
                label={translate('ceet2App.bondingInstructor.year')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="instructor"
                data-cy="instructor"
                label={translate('ceet2App.bondingInstructor.instructor')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="bonding"
                data-cy="bonding"
                label={translate('ceet2App.bondingInstructor.bonding')}
                type="select"
                required
              >
                <option value="" key="0" />
