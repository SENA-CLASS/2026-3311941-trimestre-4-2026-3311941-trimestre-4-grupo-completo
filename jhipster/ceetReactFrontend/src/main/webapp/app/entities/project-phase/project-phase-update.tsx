  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.projectPhase.home.createOrEditLabel" data-cy="ProjectPhaseCreateUpdateHeading">
            <Translate contentKey="ceet2App.projectPhase.home.createOrEditLabel">Create or edit a ProjectPhase</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.projectPhase.projectPhaseCode')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.projectPhase.projectPhaseState')}
              ...
              <ValidatedField
                ...
                name="project"
                data-cy="project"
                label={translate('ceet2App.projectPhase.project')}
                type="select"
                required
              >
                <option value="" key="0" />
