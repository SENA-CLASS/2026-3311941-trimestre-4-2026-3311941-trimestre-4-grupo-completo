...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTPHASE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTPHASE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTPHASE actions', async () => {
      const arg = { id: 'f66f01f6-089b-45fa-8a8f-13705ed76a37' };
    ...
    it('dispatches UPDATE_PROJECTPHASE actions', async () => {
      const arg = { id: 'f66f01f6-089b-45fa-8a8f-13705ed76a37' };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTPHASE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PROJECTPHASE actions', async () => {
      const arg = 42666;
