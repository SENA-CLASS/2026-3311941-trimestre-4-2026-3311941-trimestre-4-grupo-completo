  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.course.home.createOrEditLabel" data-cy="CourseCreateUpdateHeading">
            <Translate contentKey="ceet2App.course.home.createOrEditLabel">Create or edit a Course</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.course.courseNumber')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.course.startDate')}
                id="course-startDate"
                name="startDate"
                data-cy="startDate"
                type="date"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.course.endDate')}
                id="course-endDate"
                name="endDate"
                data-cy="endDate"
                type="date"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.course.route')}
                id="course-route"
                name="route"
                data-cy="route"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.course.courseStatus')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.course.workingDayCourse')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.course.trainingProgram')}
                type="select"
                required
              >
                <option value="" key="0" />
