    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseDetailsHeading">
          <Translate contentKey="ceet2App.course.detail.title">Course</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="route">
              <Translate contentKey="ceet2App.course.route">Route</Translate>
            </span>
          </dt>
          <dd>{courseEntity.route}</dd>
          <dt>
            <Translate contentKey="ceet2App.course.courseStatus">Course Status</Translate>
          </dt>
          <dd>{courseEntity.courseStatus ? courseEntity.courseStatus.nameCourseStatus : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.course.workingDayCourse">Working Day Course</Translate>
          </dt>
          <dd>{courseEntity.workingDayCourse ? courseEntity.workingDayCourse.workingDayName : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.course.trainingProgram">Training Program</Translate>
          </dt>
