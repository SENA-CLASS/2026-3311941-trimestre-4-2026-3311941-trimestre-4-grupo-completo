  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.areaInstructor.home.createOrEditLabel" data-cy="AreaInstructorCreateUpdateHeading">
            <Translate contentKey="ceet2App.areaInstructor.home.createOrEditLabel">Create or edit a AreaInstructor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.areaInstructor.areaInstructorState')}
              ...
              <ValidatedField
                ...
                name="area"
                data-cy="area"
                label={translate('ceet2App.areaInstructor.area')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="instructor"
                data-cy="instructor"
                label={translate('ceet2App.areaInstructor.instructor')}
                type="select"
                required
              >
                <option value="" key="0" />
