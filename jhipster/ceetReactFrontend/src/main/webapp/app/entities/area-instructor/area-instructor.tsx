  ...
  return (
    <div>
      <h2 id="area-instructor-heading" data-cy="AreaInstructorHeading">
        <Translate contentKey="ceet2App.areaInstructor.home.title">Area Instructors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.areaInstructor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/area-instructor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceet2App.areaInstructor.home.createLabel">Create new Area Instructor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {areaInstructorList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.areaInstructor.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="ceet2App.areaInstructor.area">Area</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.areaInstructor.instructor">Instructor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {areaInstructorList.map(areaInstructor => (
                <tr key={`entity-${areaInstructor.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceet2App.State.${areaInstructor.areaInstructorState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.areaInstructor.home.notFound">No Area Instructors found</Translate>
            </div>
          )
        )}
      </div>
