...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENTQUARTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CURRENTQUARTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CURRENTQUARTER actions', async () => {
      const arg = { id: '4af0f48b-9729-4737-a11e-246ced312d2f' };
    ...
    it('dispatches UPDATE_CURRENTQUARTER actions', async () => {
      const arg = { id: '4af0f48b-9729-4737-a11e-246ced312d2f' };
    ...
    it('dispatches PARTIAL_UPDATE_CURRENTQUARTER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CURRENTQUARTER actions', async () => {
      const arg = 42666;
