    ...
    <Row>
      <Col md="8">
        <h2 data-cy="quarterScheduleDetailsHeading">
          <Translate contentKey="ceet2App.quarterSchedule.detail.title">QuarterSchedule</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.quarterSchedule.planning">Planning</Translate>
          </dt>
          <dd>{quarterScheduleEntity.planning ? quarterScheduleEntity.planning.planningCode : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.quarterSchedule.trimester">Trimester</Translate>
          </dt>
