  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.quarterSchedule.home.createOrEditLabel" data-cy="QuarterScheduleCreateUpdateHeading">
            <Translate contentKey="ceet2App.quarterSchedule.home.createOrEditLabel">Create or edit a QuarterSchedule</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.quarterSchedule.learningResult')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="planning"
                data-cy="planning"
                label={translate('ceet2App.quarterSchedule.planning')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="trimester"
                data-cy="trimester"
                label={translate('ceet2App.quarterSchedule.trimester')}
                type="select"
                required
              >
                <option value="" key="0" />
