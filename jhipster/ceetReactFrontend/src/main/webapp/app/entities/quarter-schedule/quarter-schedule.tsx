  ...
  return (
    <div>
      <h2 id="quarter-schedule-heading" data-cy="QuarterScheduleHeading">
        <Translate contentKey="ceet2App.quarterSchedule.home.title">Quarter Schedules</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.quarterSchedule.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/quarter-schedule/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceet2App.quarterSchedule.home.createLabel">Create new Quarter Schedule</Translate>
          </Link>
        </div>
      </h2>
        ...
        {quarterScheduleList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.quarterSchedule.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th>
                  <Translate contentKey="ceet2App.quarterSchedule.learningResult">Learning Result</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.quarterSchedule.planning">Planning</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ceet2App.quarterSchedule.trimester">Trimester</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.quarterSchedule.home.notFound">No Quarter Schedules found</Translate>
            </div>
          )
        )}
      </div>
