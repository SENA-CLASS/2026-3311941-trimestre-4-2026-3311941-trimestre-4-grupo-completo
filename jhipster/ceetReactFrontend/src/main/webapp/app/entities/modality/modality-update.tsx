  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.modality.home.createOrEditLabel" data-cy="ModalityCreateUpdateHeading">
            <Translate contentKey="ceet2App.modality.home.createOrEditLabel">Create or edit a Modality</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.modality.modalityName')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.modality.modalityColor')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.modality.modalityState')}
