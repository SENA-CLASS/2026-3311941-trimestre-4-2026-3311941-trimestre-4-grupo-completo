  ...
  return (
    <div>
      <h2 id="modality-heading" data-cy="ModalityHeading">
        <Translate contentKey="ceet2App.modality.home.title">Modalities</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.modality.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/modality/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ceet2App.modality.home.createLabel">Create new Modality</Translate>
          </Link>
        </div>
      </h2>
        ...
        {modalityList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.modality.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
            ...
            <tbody>
              {modalityList.map(modality => (
                <tr key={`entity-${modality.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceet2App.State.${modality.modalityState}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.modality.home.notFound">No Modalities found</Translate>
            </div>
          )
        )}
      </div>
