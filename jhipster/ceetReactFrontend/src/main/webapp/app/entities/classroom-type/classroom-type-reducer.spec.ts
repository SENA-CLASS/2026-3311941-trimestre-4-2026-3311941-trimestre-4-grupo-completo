...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSROOMTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSROOMTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSROOMTYPE actions', async () => {
      const arg = { id: '8c6dd7a6-f30f-4c8b-a878-a36dc5aee7ae' };
    ...
    it('dispatches UPDATE_CLASSROOMTYPE actions', async () => {
      const arg = { id: '8c6dd7a6-f30f-4c8b-a878-a36dc5aee7ae' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSROOMTYPE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSROOMTYPE actions', async () => {
      const arg = 42666;
