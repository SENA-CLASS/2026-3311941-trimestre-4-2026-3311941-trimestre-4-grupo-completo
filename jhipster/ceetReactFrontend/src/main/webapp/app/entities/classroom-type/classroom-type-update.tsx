  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.classroomType.home.createOrEditLabel" data-cy="ClassroomTypeCreateUpdateHeading">
            <Translate contentKey="ceet2App.classroomType.home.createOrEditLabel">Create or edit a ClassroomType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.classroomType.typeClassroom')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.classroomType.classroomDescription')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.classroomType.classroomState')}
