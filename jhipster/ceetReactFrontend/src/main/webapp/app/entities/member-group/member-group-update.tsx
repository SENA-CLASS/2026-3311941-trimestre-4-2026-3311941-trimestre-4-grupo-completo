  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.memberGroup.home.createOrEditLabel" data-cy="MemberGroupCreateUpdateHeading">
            <Translate contentKey="ceet2App.memberGroup.home.createOrEditLabel">Create or edit a MemberGroup</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.memberGroup.projectGroup')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="apprentice"
                data-cy="apprentice"
                label={translate('ceet2App.memberGroup.apprentice')}
                type="select"
                required
              >
                <option value="" key="0" />
