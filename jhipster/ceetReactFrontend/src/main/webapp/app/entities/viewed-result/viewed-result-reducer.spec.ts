...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIEWEDRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIEWEDRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIEWEDRESULT actions', async () => {
      const arg = { id: '9654f016-d4cb-4bc3-9d46-d5f6c821cccb' };
    ...
    it('dispatches UPDATE_VIEWEDRESULT actions', async () => {
      const arg = { id: '9654f016-d4cb-4bc3-9d46-d5f6c821cccb' };
    ...
    it('dispatches PARTIAL_UPDATE_VIEWEDRESULT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_VIEWEDRESULT actions', async () => {
      const arg = 42666;
