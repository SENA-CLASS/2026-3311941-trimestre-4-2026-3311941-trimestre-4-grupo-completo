  ...
  return (
    <div>
      <h2 id="training-program-heading" data-cy="TrainingProgramHeading">
        <Translate contentKey="ceet2App.trainingProgram.home.title">Training Programs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.trainingProgram.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/training-program/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ceet2App.trainingProgram.home.createLabel">Create new Training Program</Translate>
          </Link>
        </div>
      </h2>
        ...
        {trainingProgramList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.trainingProgram.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
            ...
            <tbody>
              {trainingProgramList.map(trainingProgram => (
                <tr key={`entity-${trainingProgram.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceet2App.StateProgram.${trainingProgram.programState}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.trainingProgram.home.notFound">No Training Programs found</Translate>
            </div>
          )
        )}
      </div>
