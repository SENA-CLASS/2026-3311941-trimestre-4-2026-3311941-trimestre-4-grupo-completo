...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKINGDAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORKINGDAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORKINGDAY actions', async () => {
      const arg = { id: 'fddad6dd-031d-41fc-8909-01f8ec6a7bc0' };
    ...
    it('dispatches UPDATE_WORKINGDAY actions', async () => {
      const arg = { id: 'fddad6dd-031d-41fc-8909-01f8ec6a7bc0' };
    ...
    it('dispatches PARTIAL_UPDATE_WORKINGDAY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_WORKINGDAY actions', async () => {
      const arg = 42666;
