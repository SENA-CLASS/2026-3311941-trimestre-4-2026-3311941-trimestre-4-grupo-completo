  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.boundingSchedule.home.createOrEditLabel" data-cy="BoundingScheduleCreateUpdateHeading">
            <Translate contentKey="ceet2App.boundingSchedule.home.createOrEditLabel">Create or edit a BoundingSchedule</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.boundingSchedule.bondingInstructor')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.boundingSchedule.instructorWorkingDay')}
                type="select"
                required
              >
                <option value="" key="0" />
