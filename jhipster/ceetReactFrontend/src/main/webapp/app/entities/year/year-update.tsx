  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.year.home.createOrEditLabel" data-cy="YearCreateUpdateHeading">
            <Translate contentKey="ceet2App.year.home.createOrEditLabel">Create or edit a Year</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.year.yearNumber')}
                id="year-yearNumber"
                name="yearNumber"
                data-cy="yearNumber"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.year.yearState')}
                id="year-yearState"
                name="yearState"
                data-cy="yearState"
                type="select"
