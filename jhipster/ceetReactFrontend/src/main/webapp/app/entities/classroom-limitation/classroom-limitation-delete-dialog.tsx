...
export const ClassroomLimitationDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.classroomLimitation.delete.question">
        <Translate contentKey="ceet2App.classroomLimitation.delete.question" interpolate={{ id: classroomLimitationEntity.id }}>
