...
import reducer, {
  ...
  reset,
  updateEntity,
} from './bonding-competence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONDINGCOMPETENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BONDINGCOMPETENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BONDINGCOMPETENCE actions', async () => {
      const arg = { id: 'cfd7fba8-1477-4385-86e4-1c2abc7aa2a8' };
    ...
    it('dispatches UPDATE_BONDINGCOMPETENCE actions', async () => {
      const arg = { id: 'cfd7fba8-1477-4385-86e4-1c2abc7aa2a8' };
    ...
    it('dispatches PARTIAL_UPDATE_BONDINGCOMPETENCE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BONDINGCOMPETENCE actions', async () => {
      const arg = 42666;
