...
import reducer, {
  ...
  reset,
  updateEntity,
} from './check-list-course.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKLISTCOURSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKLISTCOURSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKLISTCOURSE actions', async () => {
      const arg = { id: 'b3f905ac-b319-4b8f-b56f-0255eda3d659' };
    ...
    it('dispatches UPDATE_CHECKLISTCOURSE actions', async () => {
      const arg = { id: 'b3f905ac-b319-4b8f-b56f-0255eda3d659' };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKLISTCOURSE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CHECKLISTCOURSE actions', async () => {
      const arg = 42666;
