...
export const CourseTrimesterDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.courseTrimester.delete.question">
        <Translate contentKey="ceet2App.courseTrimester.delete.question" interpolate={{ id: courseTrimesterEntity.id }}>
