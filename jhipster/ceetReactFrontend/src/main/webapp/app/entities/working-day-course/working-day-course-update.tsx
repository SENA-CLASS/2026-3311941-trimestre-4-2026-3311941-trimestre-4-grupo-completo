  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.workingDayCourse.home.createOrEditLabel" data-cy="WorkingDayCourseCreateUpdateHeading">
            <Translate contentKey="ceet2App.workingDayCourse.home.createOrEditLabel">Create or edit a WorkingDayCourse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.workingDayCourse.workingDayAcronym')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.workingDayCourse.workingDayName')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.workingDayCourse.description')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.workingDayCourse.imageUrl')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.workingDayCourse.stateWorkingDay')}
