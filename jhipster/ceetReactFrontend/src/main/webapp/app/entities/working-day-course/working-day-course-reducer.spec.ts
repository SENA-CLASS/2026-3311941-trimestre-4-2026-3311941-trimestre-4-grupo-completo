...
import reducer, {
  ...
  reset,
  updateEntity,
} from './working-day-course.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKINGDAYCOURSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WORKINGDAYCOURSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WORKINGDAYCOURSE actions', async () => {
      const arg = { id: '647799fc-3023-41ef-914a-650d7703fb02' };
    ...
    it('dispatches UPDATE_WORKINGDAYCOURSE actions', async () => {
      const arg = { id: '647799fc-3023-41ef-914a-650d7703fb02' };
    ...
    it('dispatches PARTIAL_UPDATE_WORKINGDAYCOURSE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_WORKINGDAYCOURSE actions', async () => {
      const arg = 42666;
