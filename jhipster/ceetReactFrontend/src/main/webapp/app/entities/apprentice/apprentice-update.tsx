  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.apprentice.home.createOrEditLabel" data-cy="ApprenticeCreateUpdateHeading">
            <Translate contentKey="ceet2App.apprentice.home.createOrEditLabel">Create or edit a Apprentice</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceet2App.apprentice.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.apprentice.trainingStatus')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('ceet2App.apprentice.course')}
                type="select"
                required
              >
                <option value="" key="0" />
