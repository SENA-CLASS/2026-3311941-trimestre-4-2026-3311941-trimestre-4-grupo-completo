    ...
    <Row>
      <Col md="8">
        <h2 data-cy="apprenticeDetailsHeading">
          <Translate contentKey="ceet2App.apprentice.detail.title">Apprentice</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.apprentice.customer">Customer</Translate>
          </dt>
          <dd>{apprenticeEntity.customer ? apprenticeEntity.customer.id : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.apprentice.trainingStatus">Training Status</Translate>
          </dt>
          <dd>{apprenticeEntity.trainingStatus ? apprenticeEntity.trainingStatus.statusName : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.apprentice.course">Course</Translate>
          </dt>
