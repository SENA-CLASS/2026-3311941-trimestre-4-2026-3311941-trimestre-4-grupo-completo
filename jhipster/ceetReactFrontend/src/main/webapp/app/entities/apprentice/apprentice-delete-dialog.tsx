...
export const ApprenticeDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.apprentice.delete.question">
        <Translate contentKey="ceet2App.apprentice.delete.question" interpolate={{ id: apprenticeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ceet-confirm-delete-apprentice" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
