  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.schedule.home.createOrEditLabel" data-cy="ScheduleCreateUpdateHeading">
            <Translate contentKey="ceet2App.schedule.home.createOrEditLabel">Create or edit a Schedule</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.schedule.startTime')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.schedule.endTime')}
                id="schedule-endTime"
                name="endTime"
                data-cy="endTime"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.schedule.scheduleVersion')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="modality"
                data-cy="modality"
                label={translate('ceet2App.schedule.modality')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField id="schedule-day" name="day" data-cy="day" label={translate('ceet2App.schedule.day')} type="select" required>
                <option value="" key="0" />
                {days
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.schedule.courseTrimester')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="classroom"
                data-cy="classroom"
                label={translate('ceet2App.schedule.classroom')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="instructor"
                data-cy="instructor"
                label={translate('ceet2App.schedule.instructor')}
                type="select"
                required
              >
                <option value="" key="0" />
