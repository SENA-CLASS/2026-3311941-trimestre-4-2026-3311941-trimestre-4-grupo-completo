  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.logAudit.home.createOrEditLabel" data-cy="LogAuditCreateUpdateHeading">
            <Translate contentKey="ceet2App.logAudit.home.createOrEditLabel">Create or edit a LogAudit</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.logAudit.levelAudit')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.logAudit.logName')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.logAudit.messageAudit')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.logAudit.dateAudit')}
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('ceet2App.logAudit.customer')}
                type="select"
                required
              >
                <option value="" key="0" />
