...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './log-audit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGAUDIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOGAUDIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOGAUDIT actions', async () => {
      const arg = { id: 'f5e5d37d-e689-46a9-ae4c-92ac59e96ef3' };
    ...
    it('dispatches UPDATE_LOGAUDIT actions', async () => {
      const arg = { id: 'f5e5d37d-e689-46a9-ae4c-92ac59e96ef3' };
    ...
    it('dispatches PARTIAL_UPDATE_LOGAUDIT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LOGAUDIT actions', async () => {
      const arg = 42666;
