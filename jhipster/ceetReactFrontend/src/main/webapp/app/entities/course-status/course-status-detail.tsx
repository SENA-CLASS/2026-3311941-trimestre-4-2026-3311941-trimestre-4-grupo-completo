    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseStatusDetailsHeading">
          <Translate contentKey="ceet2App.courseStatus.detail.title">CourseStatus</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nameCourseStatus">
              <Translate contentKey="ceet2App.courseStatus.nameCourseStatus">Name Course Status</Translate>
            </span>
          </dt>
          <dd>{courseStatusEntity.nameCourseStatus}</dd>
          <dt>
            <span id="stateCourse">
              <Translate contentKey="ceet2App.courseStatus.stateCourse">State Course</Translate>
            </span>
          </dt>
