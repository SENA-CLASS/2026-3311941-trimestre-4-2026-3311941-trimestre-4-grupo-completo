...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAININGSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAININGSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAININGSTATUS actions', async () => {
      const arg = { id: 'd8ce37b3-f820-49e1-980b-7132772e61a7' };
    ...
    it('dispatches UPDATE_TRAININGSTATUS actions', async () => {
      const arg = { id: 'd8ce37b3-f820-49e1-980b-7132772e61a7' };
    ...
    it('dispatches PARTIAL_UPDATE_TRAININGSTATUS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TRAININGSTATUS actions', async () => {
      const arg = 42666;
