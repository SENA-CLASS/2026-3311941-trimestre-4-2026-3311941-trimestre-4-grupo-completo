...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './item-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ITEMLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ITEMLIST actions', async () => {
      const arg = { id: 'ecdaac4d-d1f0-45d8-a82a-a8c15fe05153' };
    ...
    it('dispatches UPDATE_ITEMLIST actions', async () => {
      const arg = { id: 'ecdaac4d-d1f0-45d8-a82a-a8c15fe05153' };
    ...
    it('dispatches PARTIAL_UPDATE_ITEMLIST actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ITEMLIST actions', async () => {
      const arg = 42666;
