    ...
    <Row>
      <Col md="8">
        <h2 data-cy="itemListDetailsHeading">
          <Translate contentKey="ceet2App.itemList.detail.title">ItemList</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="itemNumber">
              <Translate contentKey="ceet2App.itemList.itemNumber">Item Number</Translate>
            </span>
          </dt>
          <dd>{itemListEntity.itemNumber}</dd>
          <dt>
            <span id="question">
              <Translate contentKey="ceet2App.itemList.question">Question</Translate>
            </span>
          </dt>
          <dd>{itemListEntity.question}</dd>
          <dt>
            <Translate contentKey="ceet2App.itemList.checkList">Check List</Translate>
          </dt>
          <dd>{itemListEntity.checkList ? itemListEntity.checkList.listName : ''}</dd>
          <dt>
            <Translate contentKey="ceet2App.itemList.learningResult">Learning Result</Translate>
          </dt>
