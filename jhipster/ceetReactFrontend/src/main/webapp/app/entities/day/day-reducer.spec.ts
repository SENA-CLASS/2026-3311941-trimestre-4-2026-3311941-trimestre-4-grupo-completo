...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './day.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DAY actions', async () => {
      const arg = { id: 'c3c5c445-4f79-4566-bfd4-47c60ed1bf8e' };
    ...
    it('dispatches UPDATE_DAY actions', async () => {
      const arg = { id: 'c3c5c445-4f79-4566-bfd4-47c60ed1bf8e' };
    ...
    it('dispatches PARTIAL_UPDATE_DAY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DAY actions', async () => {
      const arg = 42666;
