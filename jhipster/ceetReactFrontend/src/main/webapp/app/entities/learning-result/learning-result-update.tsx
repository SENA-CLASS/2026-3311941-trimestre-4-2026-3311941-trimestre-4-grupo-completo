  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.learningResult.home.createOrEditLabel" data-cy="LearningResultCreateUpdateHeading">
            <Translate contentKey="ceet2App.learningResult.home.createOrEditLabel">Create or edit a LearningResult</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.learningResult.resultCode')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.learningResult.denomination')}
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.learningResult.learningCompetence')}
                type="select"
                required
              >
                <option value="" key="0" />
