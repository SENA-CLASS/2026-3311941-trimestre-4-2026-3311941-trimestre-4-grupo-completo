  ...
  return (
    <div>
      <h2 id="project-heading" data-cy="ProjectHeading">
        <Translate contentKey="ceet2App.project.home.title">Projects</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ceet2App.project.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/project/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ceet2App.project.home.createLabel">Create new Project</Translate>
          </Link>
        </div>
      </h2>
        ...
        {projectList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ceet2App.project.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('projectCode')}>
                  <Translate contentKey="ceet2App.project.projectCode">Project Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('projectCode')} />
                </th>
                <th className="hand" onClick={sort('projectName')}>
                  <Translate contentKey="ceet2App.project.projectName">Project Name</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('projectName')} />
                </th>
                <th className="hand" onClick={sort('projectState')}>
                  <Translate contentKey="ceet2App.project.projectState">Project State</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('projectState')} />
                </th>
                <th>
                  <Translate contentKey="ceet2App.project.trainingProgram">Training Program</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {projectList.map(project => (
                <tr key={`entity-${project.id}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ceet2App.State.${project.projectState}`} />
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ceet2App.project.home.notFound">No Projects found</Translate>
            </div>
          )
        )}
      </div>
