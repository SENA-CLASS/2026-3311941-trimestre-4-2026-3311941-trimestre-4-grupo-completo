  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.project.home.createOrEditLabel" data-cy="ProjectCreateUpdateHeading">
            <Translate contentKey="ceet2App.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.project.projectCode')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.project.projectName')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.project.projectState')}
              ...
              <ValidatedField
                ...
                label={translate('ceet2App.project.trainingProgram')}
                type="select"
                required
              >
                <option value="" key="0" />
