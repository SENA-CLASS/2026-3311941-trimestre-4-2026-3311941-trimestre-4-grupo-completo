    ...
    <Row>
      <Col md="8">
        <h2 data-cy="projectActivityDetailsHeading">
          <Translate contentKey="ceet2App.projectActivity.detail.title">ProjectActivity</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.projectActivity.projectPhase">Project Phase</Translate>
          </dt>
