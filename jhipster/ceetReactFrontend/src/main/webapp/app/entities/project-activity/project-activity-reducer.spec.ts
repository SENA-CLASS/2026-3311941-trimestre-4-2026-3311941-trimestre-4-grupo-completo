...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTACTIVITY actions', async () => {
      const arg = { id: '8fcd62e7-dc0e-453c-a593-0e57d65f34de' };
    ...
    it('dispatches UPDATE_PROJECTACTIVITY actions', async () => {
      const arg = { id: '8fcd62e7-dc0e-453c-a593-0e57d65f34de' };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTACTIVITY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PROJECTACTIVITY actions', async () => {
      const arg = 42666;
