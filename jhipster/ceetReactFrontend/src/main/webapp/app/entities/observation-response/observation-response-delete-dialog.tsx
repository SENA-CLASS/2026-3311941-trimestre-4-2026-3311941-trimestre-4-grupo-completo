...
export const ObservationResponseDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.observationResponse.delete.question">
        <Translate contentKey="ceet2App.observationResponse.delete.question" interpolate={{ id: observationResponseEntity.id }}>
