...
import reducer, {
  ...
  reset,
  updateEntity,
} from './observation-response.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBSERVATIONRESPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OBSERVATIONRESPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OBSERVATIONRESPONSE actions', async () => {
      const arg = { id: 'dd4dbde6-a955-4c60-99f4-6e3b8c107465' };
    ...
    it('dispatches UPDATE_OBSERVATIONRESPONSE actions', async () => {
      const arg = { id: 'dd4dbde6-a955-4c60-99f4-6e3b8c107465' };
    ...
    it('dispatches PARTIAL_UPDATE_OBSERVATIONRESPONSE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_OBSERVATIONRESPONSE actions', async () => {
      const arg = 42666;
