    ...
    <Row>
      <Col md="8">
        <h2 data-cy="observationResponseDetailsHeading">
          <Translate contentKey="ceet2App.observationResponse.detail.title">ObservationResponse</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="ceet2App.observationResponse.customer">Customer</Translate>
          </dt>
