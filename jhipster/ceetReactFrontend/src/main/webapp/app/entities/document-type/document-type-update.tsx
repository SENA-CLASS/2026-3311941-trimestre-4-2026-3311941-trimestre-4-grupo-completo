  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceet2App.documentType.home.createOrEditLabel" data-cy="DocumentTypeCreateUpdateHeading">
            <Translate contentKey="ceet2App.documentType.home.createOrEditLabel">Create or edit a DocumentType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ceet2App.documentType.initials')}
              ...
              />
              <ValidatedField
                label={translate('ceet2App.documentType.documentName')}
                id="document-type-documentName"
                name="documentName"
              ...
              />
              <ValidatedField
                label={translate('ceet2App.documentType.stateDocumentType')}
                id="document-type-stateDocumentType"
