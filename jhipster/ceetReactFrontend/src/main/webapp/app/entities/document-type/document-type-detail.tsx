    ...
    <Row>
      <Col md="8">
        <h2 data-cy="documentTypeDetailsHeading">
          <Translate contentKey="ceet2App.documentType.detail.title">DocumentType</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{documentTypeEntity.documentName}</dd>
          <dt>
            <span id="stateDocumentType">
              <Translate contentKey="ceet2App.documentType.stateDocumentType">State Document Type</Translate>
            </span>
          </dt>
          <dd>{documentTypeEntity.stateDocumentType}</dd>
        </dl>
