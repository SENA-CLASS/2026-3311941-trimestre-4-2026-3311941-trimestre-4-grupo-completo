...
export const DocumentTypeDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ceet2App.documentType.delete.question">
        <Translate contentKey="ceet2App.documentType.delete.question" interpolate={{ id: documentTypeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ceet-confirm-delete-documentType" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
