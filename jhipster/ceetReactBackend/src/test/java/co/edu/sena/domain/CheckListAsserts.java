...
public class CheckListAsserts {
    ...
    public static void assertCheckListUpdatableFieldsEquals(CheckList expected, CheckList actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getListName()).as("check listName").isEqualTo(expected.getListName()))
            .satisfies(a -> assertThat(a.getListState()).as("check listState").isEqualTo(expected.getListState()));
    }
