...
public class CourseAsserts {
    ...
    public static void assertCourseUpdatableFieldsEquals(Course expected, Course actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getCourseNumber()).as("check courseNumber").isEqualTo(expected.getCourseNumber()))
    ...
    public static void assertCourseUpdatableRelationshipsEquals(Course expected, Course actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getCourseStatus()).as("check courseStatus").isEqualTo(expected.getCourseStatus()))
