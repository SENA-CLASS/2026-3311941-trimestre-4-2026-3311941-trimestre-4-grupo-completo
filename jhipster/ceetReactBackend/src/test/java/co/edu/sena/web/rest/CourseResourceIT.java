...
import static co.edu.sena.domain.CourseAsserts.*;
...
class CourseResourceIT {
    ...
    public static Course createEntity() {
        ...
        courseStatus = CourseStatusResourceIT.createEntity();
        courseStatus.setId("fixed-id-for-tests");
        ...
        course.setWorkingDayCourse(workingDayCourse);
        // Add required entity
    ...
    public static Course createUpdatedEntity() {
        ...
        // Add required entity
        CourseStatus courseStatus;
        courseStatus = CourseStatusResourceIT.createUpdatedEntity();
        courseStatus.setId("fixed-id-for-tests");
        ...
        workingDayCourse.setId("fixed-id-for-tests");
        updatedCourse.setWorkingDayCourse(workingDayCourse);
        // Add required entity
        TrainingProgram trainingProgram;
        trainingProgram = TrainingProgramResourceIT.createUpdatedEntity();
        trainingProgram.setId("fixed-id-for-tests");
        updatedCourse.setTrainingProgram(trainingProgram);
    ...
    void getAllCourses() throws Exception {
        ...
        insertedCourse = courseRepository.save(course);
