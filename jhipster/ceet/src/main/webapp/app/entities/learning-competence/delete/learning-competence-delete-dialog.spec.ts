...
describe('LearningCompetence Management Delete Component', () => {
  let comp: LearningCompetenceDeleteDialog;
  let fixture: ComponentFixture<LearningCompetenceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LearningCompetenceDeleteDialog);
