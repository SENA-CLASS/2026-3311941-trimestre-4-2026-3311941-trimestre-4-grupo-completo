...
describe('ProjectActivity Management Delete Component', () => {
  let comp: ProjectActivityDeleteDialog;
  let fixture: ComponentFixture<ProjectActivityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProjectActivityDeleteDialog);
