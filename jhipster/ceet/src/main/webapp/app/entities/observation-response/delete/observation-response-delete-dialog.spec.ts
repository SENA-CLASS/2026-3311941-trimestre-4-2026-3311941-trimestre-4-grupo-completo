...
describe('ObservationResponse Management Delete Component', () => {
  let comp: ObservationResponseDeleteDialog;
  let fixture: ComponentFixture<ObservationResponseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ObservationResponseDeleteDialog);
