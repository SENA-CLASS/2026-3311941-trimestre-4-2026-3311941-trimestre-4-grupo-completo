...
describe('CoursePlanning Management Delete Component', () => {
  let comp: CoursePlanningDeleteDialog;
  let fixture: ComponentFixture<CoursePlanningDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CoursePlanningDeleteDialog);
