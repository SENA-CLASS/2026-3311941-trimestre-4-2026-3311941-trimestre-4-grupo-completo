...
describe('BondingCompetence Management Delete Component', () => {
  let comp: BondingCompetenceDeleteDialog;
  let fixture: ComponentFixture<BondingCompetenceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BondingCompetenceDeleteDialog);
