...
describe('BondingInstructor Management Delete Component', () => {
  let comp: BondingInstructorDeleteDialog;
  let fixture: ComponentFixture<BondingInstructorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BondingInstructorDeleteDialog);
