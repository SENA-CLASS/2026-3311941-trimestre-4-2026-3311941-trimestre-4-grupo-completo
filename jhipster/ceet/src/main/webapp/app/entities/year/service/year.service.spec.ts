...
describe('Year Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Year', () => {
      ...
      service.create(year).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Year', () => {
      ...
      service.update(year).subscribe(resp => (expectedResult = resp));
    ...
    describe('addYearToCollectionIfMissing', () => {
      it('should add a Year to an empty array', () => {
        ...
        expect(expectedResult).toEqual([year]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([year, year2]);
      });
