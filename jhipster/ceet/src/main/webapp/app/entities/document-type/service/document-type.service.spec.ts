...
describe('DocumentType Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a DocumentType', () => {
      ...
      service.create(documentType).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a DocumentType', () => {
      ...
      service.update(documentType).subscribe(resp => (expectedResult = resp));
    ...
    describe('compareDocumentType', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '4eea9f54-84fe-4142-b830-d89e8cb3c84a' };
        const entity2 = null;
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '4eea9f54-84fe-4142-b830-d89e8cb3c84a' };
        const entity2 = { id: '4eea9f54-84fe-4142-b830-d89e8cb3c84a' };
