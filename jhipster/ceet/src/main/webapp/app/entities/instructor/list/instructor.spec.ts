...
describe('Instructor Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '6fe9ece4-df13-40c8-9fc2-90d39fd11224' }], {
    ...
    expect(comp.instructors()[0]).toEqual(expect.objectContaining({ id: '6fe9ece4-df13-40c8-9fc2-90d39fd11224' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '6fe9ece4-df13-40c8-9fc2-90d39fd11224' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: '6fe9ece4-df13-40c8-9fc2-90d39fd11224' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
