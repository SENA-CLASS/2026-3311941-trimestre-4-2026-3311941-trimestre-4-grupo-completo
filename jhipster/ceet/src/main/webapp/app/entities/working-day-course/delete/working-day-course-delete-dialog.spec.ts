...
describe('WorkingDayCourse Management Delete Component', () => {
  let comp: WorkingDayCourseDeleteDialog;
  let fixture: ComponentFixture<WorkingDayCourseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkingDayCourseDeleteDialog);
