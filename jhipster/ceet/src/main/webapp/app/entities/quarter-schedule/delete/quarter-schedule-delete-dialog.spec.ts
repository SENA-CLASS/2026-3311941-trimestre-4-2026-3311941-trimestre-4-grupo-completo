...
describe('QuarterSchedule Management Delete Component', () => {
  let comp: QuarterScheduleDeleteDialog;
  let fixture: ComponentFixture<QuarterScheduleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuarterScheduleDeleteDialog);
