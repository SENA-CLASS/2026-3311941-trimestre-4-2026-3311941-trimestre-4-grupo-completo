...
describe('MemberGroup Management Component', () => {
  ...
  let comp: MemberGroup;
  let fixture: ComponentFixture<MemberGroup>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MemberGroup);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'aaafac9c-00f1-42dd-b0bb-5944cf56fc08' }], {
    ...
    expect(comp.memberGroups()[0]).toEqual(expect.objectContaining({ id: 'aaafac9c-00f1-42dd-b0bb-5944cf56fc08' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: 'aaafac9c-00f1-42dd-b0bb-5944cf56fc08' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.memberGroups()).toEqual([]);

    // WHEN - second load should still work
    comp.load();
    TestBed.tick();
    const successReq = httpMock.expectOne({ method: 'GET' });
    successReq.flush([{ id: 'aaafac9c-00f1-42dd-b0bb-5944cf56fc08' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to memberGroupService', () => {
      const entity = { id: 'aaafac9c-00f1-42dd-b0bb-5944cf56fc08' };
      vitest.spyOn(service, 'getMemberGroupIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.memberGroupsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
