...
describe('LevelEducation Management Delete Component', () => {
  let comp: LevelEducationDeleteDialog;
  let fixture: ComponentFixture<LevelEducationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LevelEducationDeleteDialog);
