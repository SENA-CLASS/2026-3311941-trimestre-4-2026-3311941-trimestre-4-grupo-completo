...
describe('Customer Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'da280165-638b-4501-b7f6-8e853e58ca86' }], {
    ...
    expect(comp.customers()[0]).toEqual(expect.objectContaining({ id: 'da280165-638b-4501-b7f6-8e853e58ca86' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: 'da280165-638b-4501-b7f6-8e853e58ca86' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: 'da280165-638b-4501-b7f6-8e853e58ca86' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
