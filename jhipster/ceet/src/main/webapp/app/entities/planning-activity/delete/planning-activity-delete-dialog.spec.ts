...
describe('PlanningActivity Management Delete Component', () => {
  let comp: PlanningActivityDeleteDialog;
  let fixture: ComponentFixture<PlanningActivityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanningActivityDeleteDialog);
