...
describe('ClassroomLimitation Management Delete Component', () => {
  let comp: ClassroomLimitationDeleteDialog;
  let fixture: ComponentFixture<ClassroomLimitationDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ClassroomLimitationDeleteDialog);
