...
describe('BoundingSchedule Management Delete Component', () => {
  let comp: BoundingScheduleDeleteDialog;
  let fixture: ComponentFixture<BoundingScheduleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BoundingScheduleDeleteDialog);
