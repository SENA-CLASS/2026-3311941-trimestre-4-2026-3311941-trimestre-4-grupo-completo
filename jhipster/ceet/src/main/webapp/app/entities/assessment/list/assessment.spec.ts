...
describe('Assessment Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'bb314d01-ba25-4918-b045-cdb0e554b9e7' }], {
    ...
    expect(comp.assessments()[0]).toEqual(expect.objectContaining({ id: 'bb314d01-ba25-4918-b045-cdb0e554b9e7' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: 'bb314d01-ba25-4918-b045-cdb0e554b9e7' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    successReq.flush([{ id: 'bb314d01-ba25-4918-b045-cdb0e554b9e7' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vitest.runAllTimersAsync();
