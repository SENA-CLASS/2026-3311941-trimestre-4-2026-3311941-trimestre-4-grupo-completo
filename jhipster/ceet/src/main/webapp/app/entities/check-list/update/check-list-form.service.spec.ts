...
import { sampleWithNewData, sampleWithRequiredData } from '../check-list.test-samples';
  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            listName: expect.any(Object),
            listState: expect.any(Object),
    ...
    describe('getCheckList', () => {
      it('should return NewCheckList for default CheckList initial value', () => {
        ...
        const checkList = service.getCheckList(formGroup);
